...
from fias.models import (
    ...
    OperStat, StrStat, Version, Status
)
...
class VersionAdmin(ViewAdmin):
    list_display = ('ver', 'dumpdate',)


@admin.register(Status)
class StatusAdmin(ViewAdmin):
    list_display = ('table', 'ver')


# gnedoy Исключаем из ФИАС из админ
""""
